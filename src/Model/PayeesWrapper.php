 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PayeesWrapper implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PayeesWrapper';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['payees'] === null) {
            $invalidProperties[] = "'payees' can't be null";
        }
